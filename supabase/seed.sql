...
('w2b','world-compass-001','matching',2,'{"pairs":[["Север","North"],["Юг","South"],["Восток","East"],["Запад","West"]]}','{"xp":10}'),
...
('a2b','animals-habitat-001','matching',2,'{"pairs":[["Верблюд","Пустыня"],["Дельфин","Море"],["Лев","Саванна"]]}','{"xp":10}'),
